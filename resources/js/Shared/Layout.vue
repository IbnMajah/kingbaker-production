    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-brand-900 md:shrink-0 md:justify-center md:w-56">
            <Link class="mt-1" href="/">
              <logo class="fill-white" width="80" height="24" />
            </Link>
            <dropdown class="md:hidden" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 px-8 py-4 bg-brand-800 rounded shadow-lg">
                  <main-menu />
                </div>
              </template>
            </dropdown>
        ...
        <div class="md:flex md:grow md:overflow-hidden">
          <main-menu class="hidden shrink-0 p-12 w-56 bg-brand-800 overflow-y-auto md:block" />
