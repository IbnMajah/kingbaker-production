<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <Link class="btn-kingbaker" href="/categories/create">
        <span>Create</span>
    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="category in categories.data" :key="category.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
            <Link class="flex items-center px-6 py-4 focus:text-brand-500" :href="`/categories/${category.id}/edit`">
              {{ category.name }}
        ...
        <tr v-if="categories.length === 0">
          <td class="px-6 py-4 border-t" colspan="3">No categories found.</td>
        </tr>
      </table>
    </div>
